 ...
 */
class Pago extends \RetiraentradaBundle\Entity\Pago implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'RetiraentradaBundle\\Entity\\Pago' . "\0" . 'id', '' . "\0" . 'RetiraentradaBundle\\Entity\\Pago' . "\0" . 'monto', '' . "\0" . 'RetiraentradaBundle\\Entity\\Pago' . "\0" . 'fecha', '' . "\0" . 'RetiraentradaBundle\\Entity\\Pago' . "\0" . 'idFormaPago'];
        }
    ...
    public function setIdFormaPago(\RetiraentradaBundle\Entity\Formapago $idFormaPago = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdFormaPago', [$idFormaPago]);
    ...
    public function getIdFormaPago()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdFormaPago', []);
