 ...
 */
class Funcion extends \RetiraentradaBundle\Entity\Funcion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'RetiraentradaBundle\\Entity\\Funcion' . "\0" . 'id', '' . "\0" . 'RetiraentradaBundle\\Entity\\Funcion' . "\0" . 'precio', '' . "\0" . 'RetiraentradaBundle\\Entity\\Funcion' . "\0" . 'hora', '' . "\0" . 'RetiraentradaBundle\\Entity\\Funcion' . "\0" . 'fecha', '' . "\0" . 'RetiraentradaBundle\\Entity\\Funcion' . "\0" . 'estado', '' . "\0" . 'RetiraentradaBundle\\Entity\\Funcion' . "\0" . 'disponibles', '' . "\0" . 'RetiraentradaBundle\\Entity\\Funcion' . "\0" . 'idPeliCopia', '' . "\0" . 'RetiraentradaBundle\\Entity\\Funcion' . "\0" . 'idSala'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Funcion $proxy) {
    ...
    public function setDisponibles($disponibles)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDisponibles', [$disponibles]);

        return parent::setDisponibles($disponibles);
    }
    ...
    public function setIdPeliCopia(\RetiraentradaBundle\Entity\Pelicopia $idPeliCopia = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdPeliCopia', [$idPeliCopia]);

        return parent::setIdPeliCopia($idPeliCopia);
    }
    ...
    public function getIdPeliCopia()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdPeliCopia', []);

        return parent::getIdPeliCopia();
    }
