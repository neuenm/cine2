 ...
 */
class Pelicula extends \CineBundle\Entity\Pelicula implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CineBundle\\Entity\\Pelicula' . "\0" . 'id', '' . "\0" . 'CineBundle\\Entity\\Pelicula' . "\0" . 'nombre', '' . "\0" . 'CineBundle\\Entity\\Pelicula' . "\0" . 'duracion', '' . "\0" . 'CineBundle\\Entity\\Pelicula' . "\0" . 'fechaEstreno', '' . "\0" . 'CineBundle\\Entity\\Pelicula' . "\0" . 'estado', '' . "\0" . 'CineBundle\\Entity\\Pelicula' . "\0" . 'imagen', '' . "\0" . 'CineBundle\\Entity\\Pelicula' . "\0" . 'idGenero', '' . "\0" . 'CineBundle\\Entity\\Pelicula' . "\0" . 'sinopsis'];
        }
